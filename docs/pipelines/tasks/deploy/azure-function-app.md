...
By design, Microsoft hosted agent won't work with App Service Environments. A private agent must be configured in a Virtual Machine which is present within in the same VNet as that of the App Service Environment.
